...
Всё что было изучено, стало для меня новой полезной информацией. Возникли некоторые трудности при создании системы достижений, так как код из видео-лекции не работал. Так что пришлось немного самому подумал и решить эту проблему.
